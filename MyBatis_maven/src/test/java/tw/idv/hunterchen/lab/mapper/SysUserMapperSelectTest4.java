...
public class SysUserMapperSelectTest4 extends BaseMapperTest{
	...
	public void testSelectRoleByUserIdAndRoleEnabled() {
		...
		try {
			...
			//3.執行Sql述句、取得結果
			List<SysRole> sysRoleList = sysUserMapper.selectRolesByUserIdAndRoleEnabled((long) 1, 1);
			List<SysRole> sysRoleList1 = sysUserMapper.selectRolesByUserIdAndRoleEnabled1((long) 1, 1);
			//4.檢驗
			Assert.assertNotNull(sysRoleList);
			Assert.assertNotNull(sysRoleList1);
